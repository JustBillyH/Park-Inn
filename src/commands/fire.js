    ...
    if (Username) {
      const userid = await rbx.getIdFromUsername(Username);
        if (Reason) {
            ...
            MessageEmbed(Moderator, 0XFF5151, 'Please provide the reason of why you want to fire the ROBLOX user.\n\nUsage: `fire <ROBLOX user/id> <reason>`');
        };
    } else {
        MessageEmbed(Moderator, 0XFF5151, 'Invalid Arguments Provided.\n\nUsage: `fire <ROBLOX user/id> <reason>`');
    };
...
exports.help = {
  name: "fire",
  category: "Roblox",
  description: "Fires the mentioned ROBLOX user.",
  usage: "fire <ROBLOX name/id> <reason>"
};