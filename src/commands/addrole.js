 exports.run = (client, msg, args) => {
    if (!msg.guild.member(client.user).hasPermission("SEND_MESSAGES")) return msg.reply(":no_entry_sign: **Error:** I don't have the **Manage Roles** permission!");
    if (!msg.member.hasPermission("SEND_MESSAGES")) return msg.reply(":no_entry_sign: **Error:** You don't have the **Manage Roles** permission!");
