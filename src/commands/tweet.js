...
var Filter = require('bad-words'),
    filter = new Filter();
var tweetlink = "https://twitter.com/iManager_"; //twitter profile here

const tweetend = new Discord.MessageEmbed()
    ...
    .setColor("#008000")
const tweeterror = new Discord.MessageEmbed()
    .setTitle("Tweet Failed")
    .setDescription("The tweet failed Please try again later.")
    .setColor("#F90000")
const tweernoargs = new Discord.MessageEmbed()
    .setTitle("Tweet Failed")
    .setDescription("You must type something to tweet!")
    .setColor("#F90000")
const tweernoargs2 = new Discord.MessageEmbed()
    .setTitle("Tweet Failed")
    .setDescription("The tweet includes a bad word.")
    .setColor("#F90000")
exports.run = async (bot, message, args) => {
    /*
    if(message.author.id !== '399982462245011456' && message.author.id !== '') return;
    ...
    */
    ...
    client.post('statuses/update', {
        status: whattotweet + " \n\n --NOTE: This is not posted nor condoned by Park Inn's Bot\n\n Posted by: " + message.author.tag
...
exports.help = {
  name: "tweet",
  category: "Twitter",
  description: "Sends a Tweet to Twitter.",
  usage: "Tweet [Text]"
};